 ...
 * @author MD
 */
public class Laporan_RT04 extends javax.swing.JInternalFrame {
 private Connection koneksi;
    ...
    private void initComponents() {
        ...
        LabelHeader2_Kelompok2.setText("LAPORAN DATA RT 04");
        ...
        ButtonKKRT04_Kelompok2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/family (1).png"))); // NOI18N
        ...
        ButtonRT04_Kelompok2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/user.png"))); // NOI18N
        ...
        ButtonBRT04_Kelompok2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/checklist.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(ButtonRT04_Kelompok2, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(ButtonKKRT04_Kelompok2, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ButtonKKRT04_Kelompok2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ButtonBRT04_Kelompok2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ButtonRT04_Kelompok2, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void ButtonKKRT04_Kelompok2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonKKRT04_Kelompok2ActionPerformed
        try {
           ...
           File file = new File("src/Laporan/Keluarga_RT04.jasper");
    ...
    private void ButtonRT04_Kelompok2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRT04_Kelompok2ActionPerformed
       try {
           ...
           Class.forName("com.mysql.jdbc.Driver");
           Connection con = DriverManager.getConnection("jdbc:mysql:"+"///desa_sekekuda","root","");
           File file = new File("src/Laporan/Warga_RT04.jasper");
           JasperReport jr = (JasperReport) JRLoader.loadObject(file);
           JasperPrint jp = JasperFillManager.fillReport(jr, parameter, con);
           JasperViewer.viewReport(jp, false);
           JasperViewer.setDefaultLookAndFeelDecorated(true);
    ...
    private void ButtonBRT04_Kelompok2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonBRT04_Kelompok2ActionPerformed
        try {
           ...
           Class.forName("com.mysql.jdbc.Driver");
           Connection con = DriverManager.getConnection("jdbc:mysql:"+"///desa_sekekuda","root","");
           File file = new File("src/Laporan/Bantuan_RT04.jasper");
           JasperReport jr = (JasperReport) JRLoader.loadObject(file);
           JasperPrint jp = JasperFillManager.fillReport(jr, parameter, con);
           JasperViewer.viewReport(jp, false);
           JasperViewer.setDefaultLookAndFeelDecorated(true);
    ...
    public javax.swing.JButton ButtonBRT04_Kelompok2;
    public javax.swing.JButton ButtonKKRT04_Kelompok2;
    public javax.swing.JButton ButtonRT04_Kelompok2;
